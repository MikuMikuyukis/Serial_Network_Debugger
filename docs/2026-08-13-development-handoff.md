...
> [!IMPORTANT]
> 这是 2026-08-13 的历史开发快照，其中的提交号、分支状态、测试数量和“后续功能”描述已经可能过时。当前实现请以 [`AI-development-guide.md`](AI-development-guide.md)、根目录 [`AGENTS.md`](../AGENTS.md)、[`README.md`](../README.md) 以及当前源码和测试为准。后续 AI 不应直接根据本文的旧状态执行合并、回退或功能判断。
